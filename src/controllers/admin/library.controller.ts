 ...
 */
const getActiveBranchesList: Controller = async (req: Request, res: Response) => {
 ...
 */
const updateBranchDetails: Controller = async (req: Request, res: Response) => {
 ...
 */
const deactivateBranch: Controller = async (req: Request, res: Response) => {
  const { branchID } = req.params
 ...
 */
const deleteBranchPermanently: Controller = async (req: Request, res: Response) => {
  const { branchID } = req.params
